...
vim.keymap.set('n', '<F9>', ':call vimspector#StepIOut()<CR>')
vim.keymap.set('n', '<F10>', ':call vimspector#Continue()<CR>')

vim.keymap.set('n', '<F11>', ':call vimspector#Stop()<CR>:call vimspector#Reset()<CR>')
